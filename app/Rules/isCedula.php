...
class isCedula implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        if (is_numeric($cedula)) {//verificamos si el dato ingresado es un numero
            ...
            if (count($cedula) == 10 && $cedula[0] . $cedula[1] <= 24 && $cedula[0] . $cedula[1] >= 0 && $cedula[2] < 6) {//verificamos si son 10 numeros ingresados,si los dos primeros corresponden a una provincia de ecuador entre 0 y 24,si el tercer digito es menor a 6 y mayor o igual a 0
